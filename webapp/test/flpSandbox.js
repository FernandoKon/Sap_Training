		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comlab2devtraningproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devtraningproject-display": {
								"semanticObject": "comlab2devtraningproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.traningproject",
									"url": sap.ui.require.toUrl("com/lab2dev/traningproject")
								}
							}
						}
					}
